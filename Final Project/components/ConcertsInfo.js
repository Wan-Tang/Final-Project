...
const Rating = () => {
  ...
  return (
    ...
    <StarRating
      rating={rating}
      onChange={setRating}
    /><Text style={{fontSize:20, padding:5}}>{rating}</Text>
    </View>
  );
};
...
function ReviewComment() {
  ...
  return (
    ...
    <View style={{ width: 380, flex:1, padding: 10, borderColor: "lightgray", borderWidth: 1, alignSelf: "center", borderRadius: 10, margin: 20 }}>
