...
{/* 
      <View>
        <View style={{height:3, width:600, backgroundColor:"lightgray"}}></View>

        <View style={{flexDirection:"row", gap:20}}>
          <Image source={{ uri: "https://i.scdn.co/image/ab6761610000e5eb191d43dca6f2f5a126e43e4b"}}
          style={{ width: 70, height: 70, borderRadius:60, margin:20 }}/>

          <View style={{flexDirection:"column"}}>
            <Text style={{fontSize:18, }}>Suga mommy</Text>
